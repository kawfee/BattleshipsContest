...
int main(){
    cout << "Are we random in here?" << endl;
    srand(time(NULL));
    ...
    */
    ...
    cout << "Are we made out of gravy here?" << endl;
    if (myfile.is_open())
    {
    ...
    cout << "Are we making it here?" << endl;
